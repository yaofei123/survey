...
<table class=table cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
        ...
        <td><a href=../SurveyShow.jsp?sid=<%=survey.getSId() %> target="_blank">预览</a>|<a
                href=SurveyStatisShow.jsp?sid=<%=survey.getSId() %>>查看统计</a>|<a
                href=ShowSheets.jsp?sid=<%=survey.getSId() %>>查看答卷</a>|<a
                href='javascript:ZeroFill(<%=survey.getSId() %>)'>结果清零</a></td>
    </tr>
    <%} %>
    <tr>
