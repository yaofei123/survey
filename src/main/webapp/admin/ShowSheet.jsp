...
<%@ page import="com.questionnaire.survey.entity.Answersheet" %>
...
<head>
    ...
    <title><%=cfg.getCSiteName() %>---答卷查看---<%=survey.getSName() %>
    </title>
...
<div class=nav style="text-align:left"><a href=admin_main.jsp>桌面</a>»<a href=SurveyStatis.jsp>问卷列表</a>»<a
        href=ShowSheets.jsp?sid=<%=request.getParameter("sid") %>>答卷列表</a>»查看答卷
    <hr>
</div>
<!--startprint-->
<div id="surveyBox">
    <div class="center">
        ...
        <div class="name"><%=survey.getSName() %>
        </div>
                            ...
                            switch (q.getQType().intValue()) {
                                ...
                                case 3:
                                    ...
                                    for (int i = 0; i < body.length; i++) {
                                        ...
                                        out.print("<li><input type='radio' name='answer" + q.getQId() + "' value='" + i + "' >" + body[i] + "</li>");
                                ...
                                case 5:
                                    ...
                                    out.println("<textarea name='answer" + q.getQId() + "' rows=4 cols=40></textarea>");
                                    out.println("</ul><br/>");
                                    out.println("<div id=qbox" + q.getQId() + "></div>");
                                    break;
                            }
