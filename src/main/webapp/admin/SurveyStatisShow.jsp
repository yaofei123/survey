...
<table width="100%" align="center" cellpadding="0" cellspacing="0" id="Survey_title" class="table">
    ...
    <tr>
        <td><%=bodys[j] %>:</td>
        <td><img src="images/blue.gif" width="<%=Integer.valueOf(results[j])*100.00/total*3%>" height="20"></td>
        <td><%=results[j] %>/<%=total %>&nbsp;&nbsp;<%=df.format(Integer.valueOf(results[j]) * 100.00 / total)%>%</td>
        <td>
