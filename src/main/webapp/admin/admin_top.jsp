...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgColor=#3a6592 style="color:#FFFFFF; font-size:12px;">
    <tr>
        <td height="28" width="214"><a href="admin_index.jsp" target="_blank"><IMG
                src="images/Title.gif" border="0"></a></td>
        <td width="68" nowrap="nowrap">&nbsp;</td>
        <td width="326">&nbsp;</td>
        <td width="21">&nbsp;</td>
        <td width="*" align="right" nowrap="nowrap">
            [<A class=blue href="#"
                onClick="showModalDialog('AboutSys.jsp',window,'dialogHeight:300px;dialogWidth:360px;dialogLeft:350px;help:no;status:no;scroll:no');">关于系统</A>]
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 background=images/topnav_bg.jpg>
    <TR>
        ...
        <TD valign="bottom" width="95">
            <a href="AdminModifg.jsp" target="right" title="修改密码"><img src="images/button7.gif" border="0"></a>
        </TD>
