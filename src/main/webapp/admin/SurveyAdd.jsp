<%@ page language="java" import="com.questionnaire.survey.dao.*,com.questionnaire.survey.entity.Templet,com.questionnaire.common.sql.*"
         pageEncoding="UTF-8" %>
<html>
<head>
        ...
        <table width="585" border="0" cellspacing="0" cellpadding="0" class="table">
            ...
            <tr>
                ...
                <td width=""><input type="checkbox" name="Survey_isImg" value="true"
                                    onClick="SwitchHidden('hidden_isImg');" title="">
            ...
            <tr>
                <td>设置问卷密码</td>
                <td><input type="checkbox" name="Survey_isPassword" value=true
                ...
                <td>
                    ...
                    <div id="hidden_ipLimit" style="display:none;">
                        ...
                        <div style="border-width:1;border-color:balck;border-style:solid;width:165;font-size:9pt">
                            <input type=text name="ipSta1" id="ipSta1" maxlength="3" class="a3"
                                   onKeyUp="mask(this,'Sta')" onbeforepaste="mask_c()">.
                            <input type=text name="ipSta2" id="ipSta2" maxlength="3" class="a3"
                                   onKeyUp="mask(this,'Sta')" onbeforepaste="mask_c()">.
                            <input type=text name="ipSta3" id="ipSta3" maxlength="3" class="a3"
                                   onKeyUp="mask(this,'Sta')" onbeforepaste="mask_c()">.
                            <input type=text name="ipSta4" id="ipSta4" maxlength="3" class="a3"
                                   onKeyUp="mask(this,'Sta')" onbeforepaste="mask_c()">
                        </div>
                        <br/>
                        IP段结束
                        <div style="border-width:1;border-color:balck;border-style:solid;width:165;font-size:9pt">
                            <input type=text name="ipEnd1" id="ipEnd1" maxlength="3" class="a3"
                                   onKeyUp="mask(this,'End')" onbeforepaste="mask_c()">.
                            <input type=text name="ipEnd2" id="ipEnd2" maxlength="3" class="a3"
                                   onKeyUp="mask(this,'End')" onbeforepaste="mask_c()">.
                            <input type=text name="ipEnd3" id="ipEnd3" maxlength="3" class="a3"
                                   onKeyUp="mask(this,'End')" onbeforepaste="mask_c()">.
                            <input type=text name="ipEnd4" id="ipEnd4" maxlength="3" class="a3"
                                   onKeyUp="mask(this,'End')" onbeforepaste="mask_c()">
                        </div>
                        ...
                        受限IP列表:
                        <br/>
                        <select name="Survey_ipList" size="5" style="width:270px" multiple="multiple"
                                id="Survey_ipList">
                        </select>
                        <br/>
                    </div>
