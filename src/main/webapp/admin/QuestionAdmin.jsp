<%@ page language="java" import="com.questionnaire.survey.dao.DAOFactory" pageEncoding="UTF-8" %>
<%@ page import="com.questionnaire.survey.dao.QuestionDAO" %>
<%@ page import="com.questionnaire.survey.entity.Question" %>
<%@ page import="com.questionnaire.common.pager.*" %>
<%@ page import="java.util.List" %>
<jsp:useBean id="pageConfig" class="com.questionnaire.common.pager.PageConfig"></jsp:useBean>
...
<table class=table cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
        ...
        <td>
            <a href="javascript:editQuestion(<%=question.getQId() %>)">编辑问题</a>|<%=(question.getQType() == 1 || question.getQType() == 3) ? "<a href='javascript:setJD(" + question.getQId() + ")'>设置截断</a>|<a href='javascript:setTZ(" + question.getQId() + ")'>设置跳转</a>" : "<font color=gray>设置截断</font>|<font color=gray>设置跳转</font>" %>
            |<a href='javascript:delQuestion(<%=question.getQId() %>)'>删除</a></td>
    </tr>
    <%} %>
    <tr>
...
<table class=table cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td>选择题型：</td>
        <td><input name="Question_type" id="qtype_dx" type="radio" value="1" onClick="showType('dx');">单选题 <input
                name="Question_type" type="radio" value="2" onClick="showType('fx');">多选题 <input name="Question_type"
                                                                                                 type="radio" value="3"
                                                                                                 onClick="showType('dxjk');">带文字输入的单选题
            <input name="Question_type" type="radio" value="4" onClick="showType('fxjk');">带文字输入的多选题 <input
                    name="Question_type" type="radio" value="5" onClick="showType('wd');"> 问答题
        </td>
        <td></td>
    </tr>
    <tr>
...
<div id=dx style="display: none">
    <form name="form1" action="../servlet/QuestionManage.do?op=AddQuestion&type=1" method="post"
...
<div id=fx style="display: none">
    <form name="form1" action="../servlet/QuestionManage.do?op=AddQuestion&type=2" method="post"
          onSubmit="return SubQuestion();">
        <input type="hidden" value=<%=request.getParameter("sid") %>  name="sid">
        <input type="hidden" value="" name="qBody" id="qBody">
        <input type="hidden" value="" name=qResult id="qResult">
...
<div id=dxjk style="display: none">
    <form name="form1" action="../servlet/QuestionManage.do?op=AddQuestion&type=3" method="post"
          onSubmit="return SubQuestion();">
        <input type="hidden" value=<%=request.getParameter("sid") %>  name="sid">
        <input type="hidden" value="" name="qBody" id="qBody">
        <input type="hidden" value="" name=qResult id="qResult">
        ...
        <ul type="1" id="ulAnswer">
            ...
            <li><input type=radio><input type="text" name="Answer"></li>
            <li><input type=radio><input type="text" name="Answer"></li>
            <li><input type=radio><input type="text" name="Answer"><input type="text" name="Answer_2" readonly="true"
                                                                          value="用户在此框输入自定义文本"></li>
        </ul><!--  此处一定要让</ul>紧跟在</li>之后，中间不能有任何空格或回车，因为FIREFOX认为空格或回车也是一个<li>节点，-->
        <div id="button">
...
<div id=fxjk style="display: none">
    <form name="form1" action="../servlet/QuestionManage.do?op=AddQuestion&type=4" method="post"
          onSubmit="return SubQuestion();">
        <input type="hidden" value=<%=request.getParameter("sid") %>  name="sid">
        <input type="hidden" value="" name="qBody" id="qBody">
        <input type="hidden" value="" name=qResult id="qResult">
        ...
        <ul type="1" id="ulAnswer">
            ...
            <li><input type=checkbox><input type="text" name="Answer"></li>
            <li><input type=checkbox><input type="text" name="Answer"></li>
            <li><input type=checkbox><input type="text" name="Answer"><input type="text" name="Answer_2" readonly="true"
                                                                             value="用户在此框输入自定义文本"></li>
        </ul><!--  此处一定要让</ul>紧跟在</li>之后，中间不能有任何空格或回车，因为FIREFOX认为空格或回车也是一个<li>节点，-->
        <div id="button">
...
<div id=wd style="display: none">
    <form name="form1" action="../servlet/QuestionManage.do?op=AddQuestion&type=5" method="post"
          onSubmit="return SubQuestion();">
        <input type="hidden" value=<%=request.getParameter("sid") %>  name="sid">
        <input type="hidden" value="" name="qBody" id="qBody">
        <input type="hidden" value="" name=qResult id="qResult">
