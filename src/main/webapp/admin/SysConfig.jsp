...
<form method="post" action="../servlet/ConfigManage.do" name="form1">
    <table class=table>
        <tbody>
        ...
        <tr>
            ...
            <td>&nbsp;<font color=red>* </font>给网站起个名字，将显示在浏览器标题栏上</td>
        </tr>
        <tr>
            <td>&nbsp;网站URL：</td>
            <td><input type="text" maxlength="100" size="30" name="siteURL"></td>
            <td>&nbsp;<font color=red>*</font> 指定网站的网址，如: www.***.com<br></td>
        </tr>
        <tr>
            <td>&nbsp;网站开关：</td>

            <td><input type="radio" value="true" name="siteOpen"  <%=cfg.getCIsOpen()?"checked":"" %>>开启 <input
                    type="radio" value="false" name="siteOpen" <%=cfg.getCIsOpen()?"":"checked" %>>关闭
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>&nbsp;关闭原因：</td>
            <td width=70px valign="middle"><textarea cols="30" rows="3"
                                                     name="closeWord"><%=cfg.getCCloseWord() %></textarea></td>
            <td>&nbsp;&nbsp;&nbsp; 在网站关闭时用户看到的信息</td>
        </tr>
        <tr>
            <td>&nbsp;版权信息：</td>
        ...
        <tr>
            <td valign="top"><br></td>
            <td valign="top" align="center"><input type="submit" value="提交" name="button2">&nbsp;&nbsp;&nbsp;<input
                    type="reset" value="取消" name="button3"></td>
            <td valign="top"><br></td>
        </tr>
        <tr>
            <td valign="top"><br></td>
