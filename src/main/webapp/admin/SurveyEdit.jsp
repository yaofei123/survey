...
<%@ page import="com.questionnaire.survey.entity.Survey" %>
<%@ page import="com.questionnaire.survey.entity.Templet" %>
<%
...
<div id="admin_surveyAdd_main">
    <form name="from1" action="../servlet/SurveyManage.do?op=EditSurvey" method="post" onSubmit="return CheckForm();">
        ...
        <table width="585" border="0" cellspacing="0" cellpadding="0" class="table">
            ...
            <tr>
                <td>同一IP可重复提交</td>
                <td><input name="Survey_ipRepeat" type="checkbox" value=true <%=survey.getSIpRepeat()?"checked":"" %>>
                </td>
            ...
            <tr>
                ...
                <td width=""><input type="checkbox" name="Survey_isImg" value="true"
                    ...
                    <font color=red><%=survey.getSImg() == null || "".equals(survey.getSImg()) ? "" : "已上传图片" + survey.getSImg() %>
                    </font>
            ...
            <tr>
                <td>设置问卷密码</td>
                <td><input type="checkbox" name="Survey_isPassword" value="<%=survey.getSPassword() %>"
                           onClick="SwitchHidden('hidden_isPassword');">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="hidden_ipLimit" style="display:none;">
                        该IP段内可以访问<input name="Survey_ipLimitKind" type="radio"
                                        value="白名单" <%="白名单".equals(survey.getSIpLimitType())?"checked":"" %> <%=survey.getSIpLimitType()==null||"".equals(survey.getSIpLimitType())?"checked":"" %>><br/>
                        该IP段内不可访问<input name="Survey_ipLimitKind" type="radio"
                                        value="黑名单"  <%="黑名单".equals(survey.getSIpLimitType())?"checked":"" %> ><br/>
                        IP段开始
                        <input name="Survey_ipLimitKinds" type="hidden" value="">

                        <div style="border-width:1;border-color:balck;border-style:solid;width:165;font-size:9pt">
                            <input type=text name="ipSta1" maxlength="3" class="a3" onKeyUp="mask(this,'Sta')"
                                   onbeforepaste="mask_c()">.
                            <input type=text name="ipSta2" maxlength="3" class="a3" onKeyUp="mask(this,'Sta')"
                                   onbeforepaste="mask_c()">.
                            <input type=text name="ipSta3" maxlength="3" class="a3" onKeyUp="mask(this,'Sta')"
                                   onbeforepaste="mask_c()">.
                            <input type=text name="ipSta4" maxlength="3" class="a3" onKeyUp="mask(this,'Sta')"
                                   onbeforepaste="mask_c()">
                        </div>
                        <br/>
                        IP段结束
                        <div style="border-width:1;border-color:balck;border-style:solid;width:165;font-size:9pt">
                            <input type=text name="ipEnd1" maxlength="3" class="a3" onKeyUp="mask(this,'End')"
                                   onbeforepaste="mask_c()">.
                            <input type=text name="ipEnd2" maxlength="3" class="a3" onKeyUp="mask(this,'End')"
                                   onbeforepaste="mask_c()">.
                            <input type=text name="ipEnd3" maxlength="3" class="a3" onKeyUp="mask(this,'End')"
                                   onbeforepaste="mask_c()">.
                            <input type=text name="ipEnd4" maxlength="3" class="a3" onKeyUp="mask(this,'End')"
                                   onbeforepaste="mask_c()">
                        </div>
