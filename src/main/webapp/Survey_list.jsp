...
<%@ page import="com.questionnaire.common.pager.PageControl" %>
...
<div id="head">
    ...
    <noscript>
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                ...
                width="768" height="140" align="middle">
            <param name="movie" value="Flash/move.swf"/>
            <param name="quality" value="high"/>
            <param name="Wmode" value="Transparent"/>
            <embed src="Flash/move.swf" width="768" height="140" align="middle" quality="high"
...
<div id="box">
    ...
    <div>
        <table class="table" id=SurveyAdmin>
            ...
            %>
            <tr>
                <td align="left" style="text-align:left"><a href="SurveyShow.jsp?sid=<%=s.getSId() %>"
                                                            target="_blank"><%=s.getSName().length() > 22 ? s.getSName().substring(0, 21) + "..." : s.getSName() %>
                </a></td>
                <td><%=s.getSAuthor() %>
                </td>
                <td><%=s.getSCreateDate() %>
            ...
            <tr>
                <td colspan=4 align="right"
                    style="text-align:right"><%=pc.getCurrentPageHTML() %><%=pc.getCountPageHTML() %>
                    |<%=pc.getFirstPageHTML() %>|<%=pc.getPageUpHTML() %>|<%=pc.getPageDownHTML() %>
                    |<%=pc.getLastPageHTML() %>
                </td>
            </tr>
        </table>
